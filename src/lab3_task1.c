...
int array_max(int arr[], int size) {
   int my_max = INT_MIN;// TODO: return largest element
    for (int i = 0; i < size; i++) {
        if (arr[i] > my_max) {
            my_max = arr[i];
        }
...
int array_sum(int arr[], int size) {
    ...
    return sum;// TODO: return sum of elements
     // placeholder
}

float array_avg(int arr[], int size) {
    int sum = array_sum(arr, size);// TODO: return average as float
